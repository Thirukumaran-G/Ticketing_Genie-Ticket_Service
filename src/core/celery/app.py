...
celery_app = Celery(
    ...
    include=[
        ...
        "src.core.celery.workers.email_inbound_worker",
...
celery_app.conf.update(
    ...
    task_routes={
        ...
        # Outbound email
        # send_ack removed — ai_worker owns all transactional receipts
        ...
        # Notification — was missing/wrong, tasks were falling into default queue
        "ticket.notification.notify_recipient": {"queue": "email_tasks"},
    },
    beat_schedule={
